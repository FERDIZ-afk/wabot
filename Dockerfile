...
#
RUN git clone -b master https://github.com/Imszy17/WhatsApp-BOT /home/wabot
WORKDIR /home/wabot
RUN wget https://raw.githubusercontent.com/Imszy17/WhatsApp-BOT/master/sessions/session.json
